...
const Manager: React.FC<ManagerProps> = ({ onDownloadImage, onDownloadPdf, isDownloading, handleViewPdf }) => {
    return (
        < div className='bg-background flex items-center justify-between py-2 px-1' >
